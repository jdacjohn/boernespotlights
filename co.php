...
if(isset($_GET['co']))
	...
	if(empty($_GET['co']))
		...
		{
		//echo "Co ID = " . $short . "Site ID = " .$site_id;
		...
		if(mysql_num_rows($result)==0)
			...
			while($row = mysql_fetch_array($result))
				...
				$pagetitle = $co_name;				
				$subquery = "SELECT card_video FROM card WHERE '$short'=co_id AND card_video!='' AND card_approve='1' AND city_code='1' ORDER BY card_id DESC LIMIT 1";
				$subresult = mysql_query($subquery);
				if(mysql_num_rows($subresult)==0)
					{
					$subquery_sql = "SELECT * FROM card WHERE '$short'=co_id AND card_approve='1' AND city_code = '1' ORDER BY card_id ASC";
					...
					$facebookOg = '
						...
						<meta property="og:image" content="http://boernespotlights.com/assets/img/spotlights/new-'.$card_front.'"/>
					...
					while($subrow = mysql_fetch_array($subresult))
						...
						<meta property="og:video" content="http://boernespotlights.com/assets/img/spotlights/new-'.$card_front.'">
				...
				$subquerys = "SELECT * FROM card WHERE '$short'=co_id AND card_approve='1' AND city_code = '1' AND card_front <> '' ORDER BY card_id ASC";
				...
				<a title="'.$co_name.'" rel="http://boernespotlights.com/assets/img/spotlights/tn-'.$card_front.'" href="http://www.facebook.com/sharer.php?
					s=100
					&p[url]='.$currentpage.'
					&p[images][0]=http://boernespotlights.com/assets/img/spotlights/new-'.$card_fronts.'
					&p[title]='.$co_name.'
					&p[summary]='.$co_desc.'" target="_blank" style="">
					<img src="http://boernespotlights.com/assets/img/facebook-icon.png" alt="Share on Facebook" style="margin-top:0px;" /></a></span>
				...
				<span class="st_linkedin"></span>';	$social_network_home = '<span class="st_linkedin"></span><span class="st_facebook" st_url="http://boernespotlights.com/company/'.$short.'" st_title="'.$co_name.'" >';
				...
				$subquery = "SELECT * FROM card WHERE '$short'=co_id AND card_approve='1' AND city_code = '1' ORDER BY card_id ASC";
	...
	$currentpage = "http://".$_SERVER["SERVER_NAME"].$_SERVER["REQUEST_URI"];
$social_network = '<hr><span style="position:relative;top:4px;margin-right:-1px;margin-top:0px;margin-bottom:0px;padding-bottom:-10px;padding-top:10px;"><a title="'.$co_name.'" rel="http://boernespotlights.com/assets/img/spotlights/tn-'.$card_front.'" href="http://www.facebook.com/sharer.php?s=100&p[url]='.$currentpage.'&p[images][0]=http://boernespotlights.com/assets/img/spotlights/new-'.$card_front.'&p[title]='.$co_name.'&p[summary]='.$co_desc.'" target="_blank" style=""><img src="http://boernespotlights.com/assets/img/facebook-icon.png" alt="Share on Facebook" style="margin-top:0px;" /></a></span>
...
<span class="st_linkedin"></span>';	$social_network_home = '<span class="st_linkedin"></span><span class="st_facebook" st_url="http://boernespotlights.com/company/'.$short.'" st_title="'.$co_name.'" ></span><span class="st_google"></span><span class="st_email"></span><a href="javascript:window.print()" class="print">Print</a>';
	echo $social_network;
	include $foot;
	}
else
