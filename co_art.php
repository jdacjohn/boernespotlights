...
if(isset($_GET['art']))
	...
	if(empty($_GET['art']))
		...
		{
		$query = "SELECT co_art.co_art_name, co_art.co_art_desc FROM card, co, co_art, co_art_list WHERE '$short'=co_art.co_art_id AND co_art.co_art_id=co_art_list.co_art_id AND co_art_list.co_id=co.co_id AND '$site_id'=card.site_id AND card.co_id=co.co_id AND card.card_approve='1' AND card.city_code='1' AND card.card_video='' LIMIT 1";
		...
		$social_network = '<hr><span style="position:relative;top:4px;margin-right:-1px;margin-top:0px;margin-bottom:0px;padding-bottom:-10px;padding-top:10px;"><a title="'.$co_art_name.'" href="http://www.facebook.com/sharer.php?s=100&p[url]='.$currentpage.'&p[images][0]=http://boernespotlights.com/assets/img/logo.png&p[title]='.$co_art_name.'&p[summary]='.$co_art_desc.'" target="_blank" style=""><img src="http://boernespotlights.com/assets/img/facebook-icon.png" alt="Share on Facebook" style="margin-top:0px;" /></a></span>
