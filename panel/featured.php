<?php $pagetitle = "Featured Company"; include '../core/base.php'; include '../'.$head; check_logged(); check_access(2);
...
if(isset($_GET['add']))
	...
	if(empty($_GET['add']))
		...
		if(mysql_num_rows($result)==0)
			...
			echo '<p>This company is now a Featured Company. You will be redirected to the <a href="/panel/admin">Admin Panel</a> shortly.</p><meta http-equiv=Refresh content=5;url=/panel/admin>';
			}
		}
	}
	...
	if(empty($_GET['del']))
		...
		if(mysql_num_rows($result)==0)
			...
			while($row = mysql_fetch_array($result))
				...
				echo '<p>This company is no longer a Featured Company. You will be redirected to the <a href="/panel/admin">Admin Panel</a> shortly.</p><meta http-equiv=Refresh content=5;url=/panel/admin>';
				}
			}
		}
	}
