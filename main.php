...
<div id="col1">
  <?php echo '<h1><a href="' . $siteRoot . '/featured">Featured Spotlights</a></h1>'; ?>
  <hr>
  <div class="hero">
    <?php	
				...
				while($row = mysql_fetch_array($result))
					...
					$co_id = $row["co_id"];
					$co_name = $row["co_name"];
					echo '<p class="spot"><a href="' . $siteRoot .'/company/'.$co_id.'"><img src="' . $siteRoot . '/assets/img/spotlights/tn-'.$card_front.'" alt="'.$co_name.'">';
				...
				?>
    <?php echo '<a href="' . $siteRoot . '/featured" class="button">View Featured</a></div>'; ?>
</div>
<div id="col2">
<?php
...
<html>
      ...
      <!-- facebook button end -->
		...
		<link type="text/css" href="<?php echo 'http://'. $siteBase . $site_url; ?>/assets/css/prelaunch.css" rel="stylesheet" media="screen">
...
<div class="container">
    ...
    <?php
		...
		?>
          ...
          <a href="http://www.boernespotlights.com" title=""><img src="assets/img/13-070212-fac0d4.jpg" alt="" /></a>
